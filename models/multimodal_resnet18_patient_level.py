...
Description:
    ...
    The model uses ResNet18 for feature extraction from image patches, combines it with
    a clinical/nuclear feature MLP, and evaluates at both patch-level and patient-level using
    ROC AUC, calibration curves, confusion matrices, and bootstrapped confidence intervals.
...
def main():
    ...
    model = MultimodalResNet18(clinical_input_dim,
